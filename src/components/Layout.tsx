  ...
  return (
    <header className="relative h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        ...
        <img src="https://images.unsplash.com/photo-1516734212186-65267f37a358?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80" alt="layout" className="w-full h-full object-cover object-center transform scale-105" loading="eager" />
      </div>
